...
export const mockGameStatus = {
  ...
  error: null,
  result_text: "狼人阵营通过悍跳与投票引导取得胜利。",
  has_post_game: true,
  has_replay: true,
  post_game_status: "ready",
  alert_count: 0,
};
...
export const mockSseEvents = [
  ...
  { event_type: "phase_changed", round_number: 1, phase: "night", message: "第 1 夜：所有玩家闭眼，夜间行动开始。" },
  { event_type: "actor_thinking", round_number: 1, phase: "night", message: "墨白正在和狼队制定袭击策略...", data: { player_id: "player_1", role: "werewolf", context: "werewolf_chat" } },
  { event_type: "werewolf_killed", round_number: 1, phase: "night", message: "狼人选择袭击 3 号沐辰。", data: { player_id: "player_1", target_id: "player_3", target_name: "沐辰" } },
  { event_type: "seer_checked", round_number: 1, phase: "night", message: "预言家查验 1 号墨白，结果为狼人。", data: { player_id: "player_3", target_id: "player_1", target_name: "墨白", result: "狼人" } },
  { event_type: "phase_changed", round_number: 1, phase: "day_discussion", message: "第 1 天：白天讨论开始，预言家准备起跳。" },
  { event_type: "player_speech", round_number: 1, phase: "day_discussion", message: "我是预言家，昨晚查了 1 号墨白，他是狼人。", data: { player_id: "player_3", speech: "我是预言家，昨晚查了 1 号墨白，他是狼人。我的警徽流会先看 2，再看 5。", reasoning: "第一晚验出查杀，必须直接起跳带队，压缩狼队生存空间。" } },
  { event_type: "player_speech", round_number: 1, phase: "day_discussion", message: "1 号昨晚状态很紧，我更倾向相信 3 号。", data: { player_id: "player_4", speech: "1 号昨晚状态很紧，发言也没有给出身份压力下的解释。我更倾向相信 3 号。", reasoning: "3 号起跳信息完整，1 号反应偏防守。" } },
  { event_type: "player_speech", round_number: 1, phase: "day_discussion", message: "我才是真预言家，3 号是在悍跳。", data: { player_id: "player_1", speech: "我才是真预言家，昨晚查 2 号是好人。3 号这是狼人悍跳，想第一天把我抗推出局。", reasoning: "通过对跳制造信息对冲，争取让好人阵营分票。" } },
  { event_type: "belief_snapshot", round_number: 1, phase: "day_discussion", message: "信念矩阵更新：多数玩家开始怀疑 1 号。", data: { snapshots: mockReplayData.belief_snapshots.filter(s => s.round === 1) } },
  { event_type: "vote_intention_snapshot", round_number: 1, phase: "day_discussion", message: "投票意向更新：5 号从观望转向投 1 号。", data: { round_number: 1, phase: "day_discussion", speaker_id: "player_4", speaker_name: "若谷", public_speech: "1 号昨晚状态很紧，发言也没有给出身份压力下的解释。我更倾向相信 3 号。", swings: [{ player_id: "player_5", player_name: "听雪", from_seat: 3, to_seat: 1, to_target_name: "墨白" }], swing_count: 1, influence_score: 18, before: {}, after: {} } },
  { event_type: "vote_cast", round_number: 1, phase: "day_voting", message: "4 号若谷投给 1 号墨白。", data: { voter_id: "player_4", target_id: "player_1" } },
  { event_type: "vote_result", round_number: 1, phase: "day_voting", message: "1 号墨白获得 4 票，被放逐出局。", data: { target_id: "player_1", target_name: "墨白" } },
  { event_type: "player_eliminated", round_number: 1, phase: "ended_day", message: "1 号墨白出局，真实身份：狼人。", data: { player_id: "player_1", role: "werewolf" } },
  { event_type: "wolf_camp_snapshot", round_number: 1, phase: "night", message: "狼队策略切换：夜行准备收割关键神职。", data: { minds: [{ owner_seat: 2, camp_strategy: "牺牲 1 号后继续打身份差，优先处理预言家与女巫。", target_selection_id: 3 }] } },
  { event_type: "phase_changed", round_number: 2, phase: "night", message: "第 2 夜：残局进入高压博弈。" },
  { event_type: "werewolf_killed", round_number: 2, phase: "night", message: "狼人袭击 3 号沐辰。", data: { player_id: "player_2", target_id: "player_3", target_name: "沐辰" } },
  { event_type: "witch_poison_used", round_number: 2, phase: "night", message: "女巫选择毒杀 2 号夜行。", data: { player_id: "player_4", target_id: "player_2", target_name: "夜行" } },
  { event_type: "player_eliminated", round_number: 2, phase: "ended_night", message: "夜晚结束：3 号沐辰与 2 号夜行死亡。", data: [{ player_id: "player_3" }, { player_id: "player_2" }] },
  { event_type: "game_ended", round_number: 2, phase: "ended", message: "狼人阵营达成胜利条件。", data: { winner: "werewolf", winner_camp: "werewolf" } },
  { event_type: "end" },
];
